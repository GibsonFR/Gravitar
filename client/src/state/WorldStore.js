  ...
  _applyStructureAutomationSnapshots(arr, serverNow) {
    ...
    for (const snap of arr) {
      ...
      this.structures.set(id, {
        ...
        automationStatusLabel: normalized.automationStatusLabel ?? current.automationStatusLabel ?? '',
        automationStatusReason: normalized.automationStatusReason ?? current.automationStatusReason ?? '',
        automationStatusAt: normalized.automationStatusAt ?? current.automationStatusAt ?? 0,
