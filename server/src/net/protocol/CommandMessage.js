...
export function sanitizeCommandMessage(raw) {
  ...
  if (cmd === 'move_structure' || cmd === 'remove_structure' || cmd === 'repair_structure' || cmd === 'storage_open' || cmd === 'toggle_structure' || cmd === 'machine_open' || cmd === 'machine_toggle') {
