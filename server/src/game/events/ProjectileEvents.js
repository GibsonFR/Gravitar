...
function projectilePayload(projectile) {
  ...
  return {
    ...
    sourceX: q(projectile.sourceX ?? projectile.x ?? 0),
    sourceY: q(projectile.sourceY ?? projectile.y ?? 0),
    sourceSx: projectile.sourceSx | 0,
    sourceSy: projectile.sourceSy | 0,
    sourceOrigin: String(projectile.sourceOrigin || 'server'),
    sourceServerX: q(projectile.sourceServerX ?? projectile.sourceX ?? projectile.x ?? 0),
    sourceServerY: q(projectile.sourceServerY ?? projectile.sourceY ?? projectile.y ?? 0),
    sourceOriginDelta: q(projectile.sourceOriginDelta || 0, 1),
