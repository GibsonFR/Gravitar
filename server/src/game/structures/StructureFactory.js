...
export function createStructure(state, type, sx, sy, x, y, options = {}) {
  ...
  return {
    ...
    automationStatusLabel: String(options.automationStatusLabel || ''),
    automationStatusReason: String(options.automationStatusReason || ''),
    automationStatusAt: Number(options.automationStatusAt || 0) || 0,
...
export function serializeStructure(structure) {
  ...
  return {
    ...
    automationStatusLabel: structure.automationStatusLabel || '',
    automationStatusReason: structure.automationStatusReason || '',
    automationStatusAt: Number(structure.automationStatusAt || 0) || 0,
...
export function hydrateStructure(state, saved) {
  ...
  const st = createStructure(state, s.type, s.sx, s.sy, s.x, s.y, {
    ...
    automationStatusLabel: s.automationStatusLabel || '',
    automationStatusReason: s.automationStatusReason || '',
    automationStatusAt: s.automationStatusAt || 0,
