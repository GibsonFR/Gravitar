...
[STRUCTURE_TYPES.MINING_EXTRACTOR]: {
  ...
  [STRUCTURE_TYPES.CONVEYOR]: {
    ...
    name: 'Convoyeur',
    description: 'Ligne locale bon marché : transporte une ressource vers le convoyeur placé devant lui. Idéal pour relier extracteurs, machines et bras dans une base compacte.',
    radius: 32,
    tilesX: 1,
    tilesY: 1,
    w: BASE_TILE_SIZE,
  ...
  [STRUCTURE_TYPES.FAST_CONVEYOR]: {
    ...
    description: 'Ligne locale rapide : cadence plus élevée pour les chaînes de production saturées. Plus coûteux que le convoyeur standard.',
    radius: 32,
    tilesX: 1,
    tilesY: 1,
    w: BASE_TILE_SIZE,
  ...
  [STRUCTURE_TYPES.SPLITTER]: {
    ...
    name: 'Répartiteur',
    description: 'Répartit alternativement une ligne entrante vers deux sorties. Sert à équilibrer deux machines ou deux buffers.',
    radius: 48,
    tilesX: 1,
    tilesY: 2,
    w: BASE_TILE_SIZE,
  ...
  [STRUCTURE_TYPES.MERGER]: {
    ...
    name: 'Fusionneur',
    description: 'Fusionne deux lignes proches vers une sortie unique. Sert à rassembler deux extracteurs ou deux machines.',
    radius: 48,
    tilesX: 1,
    tilesY: 2,
    w: BASE_TILE_SIZE,
  ...
  [STRUCTURE_TYPES.ROBOT_ARM]: {
    ...
    name: 'Bras robotique',
    description: 'Transfert précis arrière → avant entre coffres, machines et convoyeurs. Sert à charger ou vider une machine sans réseau de drones.',
    radius: 32,
    tilesX: 1,
    tilesY: 1,
    w: BASE_TILE_SIZE,
  ...
  [STRUCTURE_TYPES.FAST_ARM]: {
    ...
    name: 'Bras rapide',
    description: 'Bras à cycle court pour alimenter les machines rapides ou vider les sorties saturées.',
    radius: 32,
    tilesX: 1,
    tilesY: 1,
    w: BASE_TILE_SIZE,
  ...
  [STRUCTURE_TYPES.LONG_ARM]: {
    ...
    name: 'Bras long',
    description: 'Bras longue portée capable de franchir une case intermédiaire pour passer au-dessus d’une ligne ou d’un espace technique.',
    radius: 32,
    tilesX: 1,
    tilesY: 1,
    w: BASE_TILE_SIZE,
