...
export const SPECIAL_SECTORS = {
  ...
  TEST_PROJECTILE_LAB: { sx: 9125, sy: -9100 },
  ...
  TEST_BIOME_ORGANIC: { sx: 9112, sy: -9100, biomeId: 'organic', label: 'Nuage organique' },
  TEST_BIOME_VOLATILE: { sx: 9113, sy: -9100, biomeId: 'volatile', label: 'Banquise hydrocarburée' },
  TEST_BIOME_NUCLEAR: { sx: 9114, sy: -9100, biomeId: 'nuclear', label: 'Zone radioactive' },
  TEST_BIOME_ANOMALY: { sx: 9115, sy: -9100, biomeId: 'anomaly', label: 'Anomalie ancienne' },
...
export function isSpecialDetachedSector(sx, sy) {
  ...
  if (sx === SPECIAL_SECTORS.TEST_TURRETS.sx) return true;
