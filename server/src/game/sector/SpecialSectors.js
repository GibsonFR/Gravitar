...
export const SPECIAL_SECTORS = {
  ...
  TEST_BIOME_METALLIC: { sx: 9110, sy: -9100, biomeId: 'metallic', label: 'Biome métal' },
  TEST_BIOME_SILICATE: { sx: 9111, sy: -9100, biomeId: 'silicate', label: 'Biome silicaté' },
  TEST_BIOME_ORGANIC: { sx: 9112, sy: -9100, biomeId: 'organic', label: 'Biome organique' },
  TEST_BIOME_VOLATILE: { sx: 9113, sy: -9100, biomeId: 'volatile', label: 'Biome volatile' },
  TEST_BIOME_NUCLEAR: { sx: 9114, sy: -9100, biomeId: 'nuclear', label: 'Biome radioactif' },
  TEST_BIOME_ANOMALY: { sx: 9115, sy: -9100, biomeId: 'anomaly', label: 'Biome anomalie' },
